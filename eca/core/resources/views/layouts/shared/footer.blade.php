      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            ...
            <p>Stay up-to-date with our news and offers</p>
          </div>
          <div class="col-lg-6">
      ...
      <div class="container">
        ...
        <div class="col-lg-3 col-md-6 footer-info">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Counselling</a></li>
                    <li><i class="bx bx-chevron-right"></i> <a href="#">Pre-Admission Support</a></li>
                    <li><i class="bx bx-chevron-right"></i> <a href="#">Upon Arrival Support</a></li>
                    <li><i class="bx bx-chevron-right"></i> <a href="#">Post-Arrival Support</a></li>
              </ul>
        </div>
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h4>Contact Us</h4>
            <p>
            <strong>Location:</strong> No. 7 Maputo Street, Zone 3 <br>
              Abuja, Nigeria. <br>
              <strong>Phone:</strong> 07040535340<br>
